...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="../../dashboard/user/<?php echo($user['account_no']);?>">Dashboard</a><div class="breadcrumb_divider"></div> <a href="../../dashboard/user_withdrawal/<?php echo($user['account_no']);?>" class="current">Withdrawal</a> </article>
		</div>
	  ...
	  <div class="clear"></div><!-- end of post new article -->
		...
		<article class="module width_full">
		  <header><h3>Withdraw Money</h3></header>
				...
				<form class="form-horizontal" role="form"  method="POST" action="../../dashboard/withdrawal/<?php echo($user['account_no']);?>">
				  ...
				  <div class="form-group">
					<th><label for="input_with" class="col-sm-2 control-label">Withdrawal Amount</label></th>
					<td>&euro; <input type="text" class="form-control" name="input_with" placeholder="Withdrawal Amount" required autofocus></td>
				  </div>
				  </tr>
				   <tr>
					<td>
