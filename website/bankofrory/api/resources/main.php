...
<?php include 'view/header.php'; ?>
   ...
   <!-- Fixed navbar -->
    ...
    <div class="container">
      ...
      <div class="jumbotron">
	  <p>&nbsp;</p>
        <div id="headingWhite"><img src="images/borlogo.png" alt="Bank of Rory Logo"  align="middle">&nbsp; Welcome To The Bank of Rory</div>
        <p>The Bank of Rory bank is a well-established online bank since 2014. We have lots of happy customers. They are happy to bank with us for many different reasons. Mainly because we care about or customers.</p>
